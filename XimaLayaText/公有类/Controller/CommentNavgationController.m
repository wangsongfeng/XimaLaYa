...
#import "CommentNavgationController.h"
#import "PlayView.h"
// 播放
#import <AVFoundation/AVFoundation.h>
@interface CommentNavgationController ()<PlayViewDelegate>
...
@implementation CommentNavgationController
...
- (void)playingWithInfoDictionary:(NSNotification *)notification {
    ...
    self.playView.contentIV.image=[UIImage imageWithData:[NSData dataWithContentsOfURL:coverURL]];
